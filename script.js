...
const translations = {
  ar: {
    ...
    // الباقات (عناوين الباقات وأوصافها)
    packages_title: 'باقات سفر مميزة',
    package_paris_title: 'رحلة باريس',
    package_bali_title: 'عطلة بالي',
    package_dubai_title: 'دبي الفاخرة',
    package_morocco_title: 'المغرب الساحر',
  ...
  en: {
    ...
    package_dubai_title: 'Luxury Dubai',
    package_morocco_title: 'Enchanting Morocco',
